...
| 43.   Реактивность, многопоточность с Coroutines (Pt.2)
|:------------------------------------------------------|
53. Вся асинхронная работа переведена на Корутины (запросы в БД, получение данных для UI и т.д.)
54. ⭐ Реализована конвертация ответа от API в DTO-объект с помощью операторов (сейчас это выполняет класс Converter).

| 44.   Реактивность, многопоточность с RxJava (Pt. 1)
|:------------------------------------------------------|
55. Вся асинхронная работа переведена на RxJava (запросы в БД, получение данных для UI и т.д.)
56. ⭐ Реализована конвертация ответа от API в DTO-объект с помощью операторов (сейчас это выполняет класс Converter).
